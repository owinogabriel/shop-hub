# React Shop-hub E-Commerce Project
...
I initialize the project using **Vite**, which provides a fast development environment.
...
I clean up boilerplate files to start with a minimal structure.
